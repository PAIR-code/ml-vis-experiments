...
// Based on https://github.com/tensorflow/tfjs-models/blob/master/universal-sentence-encoder/src/tokenizer/index.ts
...
class BertTokenizer {
  ...
  async loadVocab() {
    return fetch('https://roadtolarissa.com/colab/fpld4dp8lo/ml-vis-experiments/perturbation-saliency/third_party/processed_vocab.json')
        .then(d => d.json());
  }
